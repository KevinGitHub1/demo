package com.zmk.cms.common.dao;
...
@Component("apacheDBUtils")
public class ApacheDBUtils {
    @Autowired
    private DataSource dataSource;
    private QueryRunner queryRunner;
    private static final Logger LOG = Logger.getLogger(ApacheDBUtils.class);
    ...
    /**
     * 执行查询，将每行的结果保存到一个Object[]对象中，然后将所有Object[]对象保存到List中
     * 
     * @param sql
     * @param params
     * @return
     */
    public List<Object[]> findListObject(String sql, Object[] params) {
        queryRunner = new QueryRunner(dataSource);
        List<Object[]> list = new ArrayList<Object[]>();
        try {
            if (params == null) {
                list = (List<Object[]>) queryRunner.query(sql,
